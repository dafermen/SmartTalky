...
| ST-633 | Preparar staging HTTPS restringido — permite reunir evidencia E2E, seguridad, recursos y rollback sin abrir producción ni usar proveedores pagos automáticamente. | `EN_PROGRESO` | alta / ST-632 | Requiere release/CI verdes, acceso restringido, certificado correcto, smoke, E2E, carga observada, rollback probado y documentación; producción continúa bloqueada hasta 13/13 y aprobación final. | reglas/docs/servidor/pruebas/evidencia |
